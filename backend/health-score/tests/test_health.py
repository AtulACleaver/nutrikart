...
from backend.health-score.health import app  # will fail as import path has hyphen; tests will adjust import below

# Because package path contains a hyphen, import by path using importlib
import importlib.util
import sys
from pathlib import Path

module_path = Path(__file__).resolve().parents[1] / "health.py"
spec = importlib.util.spec_from_file_location("health_module", str(module_path))
